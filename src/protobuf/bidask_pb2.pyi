...
class BidAskProto(google.protobuf.message.Message):
    ...
    class BidAskData(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal[u"ask_price",b"ask_price",u"ask_volume",b"ask_volume",u"bid_price",b"bid_price",u"bid_volume",b"bid_volume",u"code",b"code",u"date_time",b"date_time",u"diff_ask_vol",b"diff_ask_vol",u"diff_bid_vol",b"diff_bid_vol",u"simtrade",b"simtrade",u"suspend",b"suspend"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"bid_ask",b"bid_ask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"bid_ask",b"bid_ask",u"exchange",b"exchange"]) -> None: ...
