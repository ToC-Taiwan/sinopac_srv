...
class StreamTickProto(google.protobuf.message.Message):
    ...
    class TickData(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal[u"amount",b"amount",u"ask_side_total_cnt",b"ask_side_total_cnt",u"ask_side_total_vol",b"ask_side_total_vol",u"avg_price",b"avg_price",u"bid_side_total_cnt",b"bid_side_total_cnt",u"bid_side_total_vol",b"bid_side_total_vol",u"chg_type",b"chg_type",u"close",b"close",u"code",b"code",u"date_time",b"date_time",u"high",b"high",u"low",b"low",u"open",b"open",u"pct_chg",b"pct_chg",u"price_chg",b"price_chg",u"simtrade",b"simtrade",u"suspend",b"suspend",u"tick_type",b"tick_type",u"total_amount",b"total_amount",u"total_volume",b"total_volume",u"volume",b"volume"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"tick",b"tick"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"exchange",b"exchange",u"tick",b"tick"]) -> None: ...
